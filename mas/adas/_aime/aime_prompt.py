...
base = """# Overview
You are an expert machine learning researcher testing various agentic systems. Your objective is to design building blocks such as prompts and control flows within these systems to solve complex tasks. Your aim is to design an optimal agent that performs well on the American Invitational Mathematics Examination (AIME) 2024 and 2025 problems, which evaluate advanced mathematical problem-solving abilities at the high school level.

## An example question from AIME 2024/2025:

**Question**: Let $a$, $b$, and $c$ be positive integers such that $a + b + c = 24$ and $a^2 + b^2 + c^2 = 194$. Find the value of $abc$.

**Answer (Not Given)**: 120
