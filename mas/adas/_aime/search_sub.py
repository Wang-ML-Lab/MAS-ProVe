...
from aime_prompt import get_init_archive, get_prompt, get_reflexion_prompt
from openai import AsyncOpenAI

client = AsyncOpenAI()

from utils import score_aime, get_all_examples, bootstrap_confidence_interval, random_id
...
async def evaluate_forward_fn(args, forward_str):
    ...
    examples = get_all_examples(args.dataset)
    ...
    for q_idx, res in enumerate(results):
        try:
            ...
            correct = score_aime(correct_answer, extracted_answer)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--valid_size', type=int, default=6)
