import torch
import maas.ext.maas.scripts.optimized.GAIA.train.template.prompt as prompt_custom
import maas.ext.maas.scripts.optimized.GAIA.train.template.operator as operator
from maas.ext.maas.scripts.optimized.GAIA.train.template.operator_registry import operator_mapping, operator_names
        ...
        for layer_idx, selected_names in enumerate(selected_names_layers):
            for op_name in selected_names:
                ...
                if op_name in ["Generate", "GenerateCoT"]:
                    # LLM will autonomously call web_search tool if it needs information
