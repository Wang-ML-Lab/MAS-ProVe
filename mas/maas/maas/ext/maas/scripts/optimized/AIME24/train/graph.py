import torch
import maas.ext.maas.scripts.optimized.AIME24.train.template.prompt as prompt_custom
import maas.ext.maas.scripts.optimized.AIME24.train.template.operator as operator
from maas.ext.maas.scripts.optimized.AIME24.train.template.operator_registry import operator_mapping, operator_names
