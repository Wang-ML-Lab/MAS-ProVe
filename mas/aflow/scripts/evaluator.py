...
class Evaluator:
    ...
    async def graph_evaluate(
        self, dataset: DatasetType, graph, params: dict, path: str, is_test: bool = False, use_mas: bool = True
    ...
    async def _configure_graph(self, dataset, graph, params: dict, use_mas: bool = True, tools=None, tool_functions=None):
